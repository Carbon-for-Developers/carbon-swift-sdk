...
[![CocoaPods](https://img.shields.io/badge/pod-v0.3.36-blue)](https://cocoapods.org/pods/CarbonAI)
...
2. Add `pod 'CarbonAI', '~> 0.3.36'` to your `Podfile`
