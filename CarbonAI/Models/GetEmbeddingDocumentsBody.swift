...
public struct GetEmbeddingDocumentsBody: Codable, JSONEncodable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try codingContainer.encode(query, forKey: .query)
        try codingContainer.encodeIfPresent(queryVector, forKey: .queryVector)
        try codingContainer.encode(k, forKey: .k)
        try codingContainer.encodeIfPresent(fileIds, forKey: .fileIds)
        try codingContainer.encodeIfPresent(parentFileIds, forKey: .parentFileIds)
        try codingContainer.encodeIfPresent(includeAllChildren, forKey: .includeAllChildren)
        try codingContainer.encodeIfPresent(tagsV2, forKey: .tagsV2)
        try codingContainer.encodeIfPresent(includeTags, forKey: .includeTags)
        ...
        try codingContainer.encodeIfPresent(hybridSearch, forKey: .hybridSearch)
        try codingContainer.encodeIfPresent(hybridSearchTuningParameters, forKey: .hybridSearchTuningParameters)
        ...
        try codingContainer.encodeIfPresent(includeFileLevelMetadata, forKey: .includeFileLevelMetadata)
        try codingContainer.encodeIfPresent(highAccuracy, forKey: .highAccuracy)
        try codingContainer.encodeIfPresent(rerank, forKey: .rerank)
        try codingContainer.encodeIfPresent(fileTypesAtSource, forKey: .fileTypesAtSource)
        try codingContainer.encodeIfPresent(excludeColdStorageFiles, forKey: .excludeColdStorageFiles)
    }
}
