...
public struct LeadsRequest: Codable, JSONEncodable, Hashable {
    ...
    public var filters: LeadFilters?
    public var orderBy: LeadsOrderByNullable?

    public init(dataSourceId: Int, includeRemoteData: Bool? = false, nextCursor: String? = nil, pageSize: Int? = nil, orderDir: OrderDirV2Nullable? = nil, includes: [BaseIncludes]? = nil, filters: LeadFilters? = nil, orderBy: LeadsOrderByNullable? = nil) {
