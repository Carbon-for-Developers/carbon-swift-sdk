...
public struct AccountsRequest: Codable, JSONEncodable, Hashable {
    ...
    public var orderBy: AccountsOrderByNullable?

    public init(dataSourceId: Int, includeRemoteData: Bool? = false, nextCursor: String? = nil, pageSize: Int? = nil, orderDir: OrderDirV2Nullable? = nil, includes: [BaseIncludes]? = nil, filters: AccountFilters? = nil, orderBy: AccountsOrderByNullable? = nil) {
