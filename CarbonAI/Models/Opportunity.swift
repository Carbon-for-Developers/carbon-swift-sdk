...
public struct Opportunity: Codable, JSONEncodable, Hashable {
    ...
    public init(description: String?, id: String, owner: PartialOwner, name: String?, amount: Int?, account: PartialAccountNullable?, contact: PartialContactNullable?, stage: String?, status: OpportunityStatusNullable?, closeDate: String?, lastActivityAt: String?, createdAt: String, updatedAt: String, isDeleted: Bool, tasks: [Task]?, events: [Event]?, remoteData: AnyCodable?) {
