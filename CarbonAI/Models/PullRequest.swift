...
public struct PullRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(title: String, id: Int, url: String, number: Int, state: PRState, user: User, createdAt: String, updatedAt: String, closedAt: String?, mergedAt: String?, requestedReviewers: [User], requestedTeams: [Team], labels: [Label], draft: Bool, head: HeadOrBase, base: HeadOrBase, remoteData: AnyCodable?) {
        self.title = title
        self.id = id
        self.url = url
        self.number = number
