...
public struct ContactsRequest: Codable, JSONEncodable, Hashable {
    ...
    public var filters: ContactFilters?
    public var orderBy: ContactsOrderByNullable?

    public init(dataSourceId: Int, includeRemoteData: Bool? = false, nextCursor: String? = nil, pageSize: Int? = nil, orderDir: OrderDirV2Nullable? = nil, includes: [BaseIncludes]? = nil, filters: ContactFilters? = nil, orderBy: ContactsOrderByNullable? = nil) {
