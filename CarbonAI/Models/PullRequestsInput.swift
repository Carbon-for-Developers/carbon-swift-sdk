...
public struct PullRequestsInput: Codable, JSONEncodable, Hashable {
    ...
    public var filters: PullRequestFilters?
    public var orderBy: PROrderBy?
    public var orderDir: OrderDirV2Nullable?

    public init(dataSourceId: Int, includeRemoteData: Bool? = false, repository: String, page: Int? = 1, pageSize: Int? = 30, nextCursor: String? = nil, filters: PullRequestFilters? = nil, orderBy: PROrderBy? = nil, orderDir: OrderDirV2Nullable? = nil) {
