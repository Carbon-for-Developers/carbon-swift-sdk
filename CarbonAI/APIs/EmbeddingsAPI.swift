...
open class EmbeddingsAPI {
    ...
    open class func getDocumentsWithRequestBuilder(
        ...
        do {
            ...
            return localVariableRequestBuilder.init(method: "POST", URLString: URLString, parameters: localVariableParameters, headers: localVariableHeaderParameters, requiresAuthentication: false)
        } catch {
            print("Error: \(error)")
        }
